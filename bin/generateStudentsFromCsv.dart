...
final showDebugMessages = true;

void main() async {
  var fileString = "import 'models.dart';\n\n";
  for (final className in classes) {
    fileString += 'final List<Student> _$className = [\n';
    ...
    if (!studentsFileExists) {
      ...
      showDebugMessages
          ? stdout
              .writeln('Fatal Error, data.dart file not found in bin folder')
          : () {};
      break;
    } else {
      ...
      for (var student in studentsCsvList) {
        ...
        fileString +=
            "\tStudent(fullName: '$fullName', zoomName: '$zoomName', extraData: '$extraData'),\n";
      }
      fileString += '];\n';
    }
  }
